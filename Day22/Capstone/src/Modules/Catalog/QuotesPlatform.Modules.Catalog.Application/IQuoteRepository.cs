...
namespace QuotesPlatform.Modules.Catalog.Application;
...
/// IQueryable&lt;Quote&gt; would let a caller compose a query that loads half an
...
public interface IQuoteRepository
{
    ...
    Task AddAsync(Quote aggregate, CancellationToken cancellationToken = default);
